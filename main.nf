...
//The BAM files indexation will speed processes that use them
    ...
    publishDir "results/BAM_files", mode: 'symlink' //publish mapping results with index useful for IGV visualization
...
// potential samples contaminations. Before running fastq_screen update configuration to match
// path.
...
process multi_qc{
//MultiQC summarises results from quality control modules (fastQC and FastQ Screen), 
// mapping module (STAR) and featureCounts
